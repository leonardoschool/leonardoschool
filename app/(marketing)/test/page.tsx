...
const allTests: TestCardType[] = [
  {
    ...
    dates: [
      { label: '1° appello', date: '10 dicembre 2026 (ore 11:00)' },
      { label: '2° appello', date: '11 gennaio 2027 (ore 11:00)' },
      { label: 'Pubblicazione risultati 1° appello', date: '23 dicembre 2026' },
      { label: 'Pubblicazione risultati 2° appello', date: '20 gennaio 2027' },
      { label: 'Pubblicazione graduatorie', date: '22 gennaio 2027 (ore 16:00)' },
      { label: '1a immatricolazione', date: '22-28 gennaio 2027' },
      { label: '1° scorrimento', date: '1° febbraio 2027' },
      { label: 'Scelta sedi vacanti', date: '2-5 febbraio 2027' },
      { label: '2° scorrimento', date: '8 febbraio 2027' },
      { label: '2a immatricolazione', date: '8-10 febbraio 2027' },
      { label: 'Graduatoria corsi affini', date: '16 febbraio 2027' },
      { label: 'Immatricolazione corsi affini', date: '16-20 febbraio 2027' },
    ],
    documents: [
      { title: 'Decreto ministeriale', url: 'https://www.mur.gov.it/sites/default/files/2026-07/Decreto%20Ministeriale%20n.%20941%20del%2010-7-2026.pdf' },
      { title: 'Procedure di iscrizione', url: 'https://www.mur.gov.it/sites/default/files/2026-07/All.%201%20al%20D.M.%2010-07-2026%20n.%20941.pdf' },
      { title: 'Esami di profitto', url: 'https://www.mur.gov.it/sites/default/files/2026-07/All.%202%20al%20D.M.%2010-07-2026%20n.%20941.pdf' },
      { title: 'Graduatoria nazionale residenti', url: 'https://www.mur.gov.it/sites/default/files/2026-07/All.%203%20al%20D.M.%2010-07-2026%20n.%20941.pdf' },
      { title: 'Graduatoria nazionale esteri', url: 'https://www.mur.gov.it/sites/default/files/2026-07/All.%204%20al%20D.M.%2010-07-2026%20n.%20941.pdf' },
      { title: 'Corsi affini', url: 'https://www.mur.gov.it/sites/default/files/2026-07/All.%205%20al%20D.M.%2010-07-2026%20n.%20941.pdf' },
      { title: 'Syllabus Chimica e Propedeutica Biochimica', url: 'https://www.mur.gov.it/sites/default/files/2026-06/Syllabus%20Chim.Prop_.Bioch_.%20-%20finale-%202026.pdf' },
      { title: 'Syllabus Fisica', url: 'https://www.mur.gov.it/sites/default/files/2026-06/Syllabus_FISICA_%20finale%202026.pdf' },
      { title: 'Syllabus Biologia', url: 'https://www.mur.gov.it/sites/default/files/2026-06/Syllabus_BIOLOGIA_%20finale%202026.pdf' },
  ...
  },
  {
    ...
    link: 'https://accessoprogrammato.mur.gov.it/2024/',
    dates: [
      { label: 'Test', date: '30 settembre 2026' },
  ...
  },
  {
    ...
    dates: [
      { label: 'Test IT', date: '16 settembre 2026' },
      { label: 'Test ENG', date: '17 settembre 2026' },
      { label: 'Test LM IT', date: '5 ottobre 2026' },
      { label: 'Test LM ENG', date: '7 ottobre 2026' },
    ],
    documents: [
  ...
  },
  {
    ...
    documents: [
      { title: 'Decreto ministeriale', url: 'https://www.mur.gov.it/sites/default/files/2026-06/Decreto%20Ministeriale%20n.%20706%20del%2004-06-2026.pdf' },
      { title: 'Syllabi', url: 'https://www.mur.gov.it/sites/default/files/2026-06/Decreto%20Ministeriale%20n.%20706%20Allegato%20A.pdf' },
  ...
  },
  {
    ...
    link: 'https://www.mur.gov.it/sites/default/files/2026-07/Decreto%20Ministeriale%20n.%20931%20del%2003-07-2026.pdf',
    dates: [
      { label: 'Test', date: '11 settembre 2026' },
    ],
    documents: [
      { title: 'Decreto ministeriale LM-85 bis', url: 'https://www.mur.gov.it/sites/default/files/2026-07/Decreto%20Ministeriale%20n.%20931%20del%2003-07-2026.pdf' },
      { title: 'Syllabi LM-85 bis', url: 'https://www.mur.gov.it/sites/default/files/2026-07/Decreto%20Ministeriale%20n.%20931%20Allegato%20A%20programmi.pdf' },
