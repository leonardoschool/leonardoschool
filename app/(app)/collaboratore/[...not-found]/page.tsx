...
export default function CollaboratoreNotFound() {
  return (
      ...
      <div className="max-w-2xl w-full text-center">
        ...
        <div className="mb-10">
          ...
          <p className={`text-lg ${colors.text.secondary} max-w-lg mx-auto`}>
            La pagina che stai cercando non esiste nell&apos;area collaboratore.
          </p>
        </div>
        ...
        <div className={`${colors.background.card} rounded-2xl ${colors.effects.shadow.xl} p-6 mb-8`}>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            ...
            >
              ...
              <div className="text-left">
                <p className={`font-medium ${colors.text.primary}`}>Dashboard Collaboratore</p>
