...
export default function DettaglioDomandaCollaboratorePage() {
  ...
  const deleteMutation = trpc.questions.deleteQuestion.useMutation({
    onSuccess: () => {
      ...
      router.push('/collaboratore/domande');
    },
  ...
  const duplicateMutation = trpc.questions.duplicateQuestion.useMutation({
    onSuccess: (data) => {
      ...
      if (data) {
        router.push(`/collaboratore/domande/${data.id}/modifica`);
      }
    },
    onError: handleMutationError,
  });
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            <div className="flex items-center gap-3 mb-2">
              ...
              {!isOwner && (
                <span className="flex items-center gap-1 px-2 py-1 rounded-full text-xs bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-300">
        ...
        <div className="relative">
          <div className="flex items-center gap-2">
            {isOwner ? (
              <>
                <Link
                  href={`/collaboratore/domande/${questionId}/modifica`}
              ...
              <button
                onClick={() => duplicateMutation.mutate({ id: questionId })}
