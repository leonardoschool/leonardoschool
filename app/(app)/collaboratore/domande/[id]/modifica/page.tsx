    ...
    return (
      <div className="p-6 sm:p-8 lg:p-10">
        <div className={`${colors.background.card} rounded-xl p-8 text-center`}>
          ...
          <p className={`${colors.text.muted} mb-4`}>
            Puoi modificare solo le domande che hai creato tu.
          </p>
          <div className="flex items-center justify-center gap-3">
            <Link
              href={`/collaboratore/domande/${questionId}`}
              className={`inline-flex items-center gap-2 px-4 py-2 rounded-lg ${colors.background.secondary} ${colors.text.primary}`}
            >
              Visualizza domanda
            </Link>
            <Link
  ...
  return (
    <div className="p-6 sm:p-8 lg:p-10">
      <QuestionForm 
        ...
        basePath="/collaboratore/domande" 
