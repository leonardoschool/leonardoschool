      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid lg:grid-cols-2 gap-12 max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-gradient-to-br from-red-900/20 via-gray-900/40 to-black/60 backdrop-blur-xl rounded-2xl p-8 border border-white/10">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    <h3 className="text-white font-semibold mb-1">Sede Organizzativa</h3>
                    <a 
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="tel:+393516467873" className="text-gray-300 hover:text-red-400 transition-colors">
                      +39 351 646 7873
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group">
                  ...
                  <div>
                    ...
                    <a href="mailto:info@leonardoschool.it" className="text-gray-300 hover:text-red-400 transition-colors block">
                      info@leonardoschool.it
                    </a>
                    <a href="mailto:leonardoformazionesrls@pec.it" className="text-gray-300 hover:text-red-400 transition-colors block text-sm mt-1">
                      leonardoformazionesrls@pec.it
                    </a>
                  </div>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-white/10">
                <h3 className="text-white font-semibold mb-4">Seguici sui Social</h3>
                <div className="flex gap-3">
                  ...
                  <a
                    href="http://m.me/115110770367756"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 rounded-xl bg-blue-500/20 flex items-center justify-center hover:bg-blue-500/40 transition-all transform hover:scale-110"
                    aria-label="Messenger"
                  >
                    <svg className="w-6 h-6 text-blue-400" fill="currentColor" viewBox="0 0 24 24">
                      <path d="M12 2C6.48 2 2 6.15 2 11.25c0 2.93 1.45 5.54 3.71 7.24V22l3.37-1.85c.9.25 1.85.38 2.84.38 5.52 0 10-4.15 10-9.25S17.52 2 12 2zm1.01 12.45l-2.59-2.76-5.06 2.76 5.57-5.91 2.66 2.76 4.98-2.76-5.56 5.91z"/>
                    </svg>
                  </a>
                  <a
            ...
            {/* Company Info Card */}
            <div className="bg-gradient-to-br from-gray-900/40 to-black/60 backdrop-blur-xl rounded-2xl p-6 border border-white/10">
              <h3 className="text-white font-semibold mb-3">Leonardo Formazione S.r.l.s</h3>
