...
export function EventDetail({ event, onClose, onEdit, onDelete, onDuplicate, onUserClick, onGroupClick }: EventDetailProps) {
        ...
        {(onEdit || onDelete || onDuplicate) && (
          <div className={`px-6 py-4 border-t ${colors.border.primary} flex justify-end gap-3`}>
            ...
            {onDuplicate && (
              <button
                onClick={onDuplicate}
                className={`px-4 py-2 rounded-lg flex items-center gap-2 ${colors.background.secondary} ${colors.text.primary} hover:opacity-80 transition-colors`}
              >
