...
export default function TolcSimulationLayout({
  ...
  const currentAnswer = currentQuestion
    ...
    : undefined;
  const currentQuestionImageSrc = normalizeImageSrc(questionImageSource(currentQuestion?.question));
        ...
        <main className="flex-1 min-h-0 flex flex-col bg-white dark:bg-gray-800">
          ...
          <div className="min-h-0 flex-1 p-6 lg:p-8 overflow-y-auto">
            ...
            {currentQuestion.question?.type === 'OPEN_TEXT' ? (
              ...
              <div className="space-y-3">
                {currentQuestion.question?.answers?.map((answer: { id: string; text: string; imageUrl?: string; imageStoragePath?: string | null }, idx: number) => {
